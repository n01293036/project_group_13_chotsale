                ...
                fAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()) {
                            Toast.makeText(SignIn.this, "Logged is successful", Toast.LENGTH_SHORT).show();
                            DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("User")
                                    .child(fAuth.getCurrentUser().getUid());
                            startActivity(new Intent(SignIn.this, GreetingScreen.class));
                            finish();
                        }else {
                            Toast.makeText(SignIn.this, "Logged is failed" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
